...
class BackgroundTaskTeacher extends AsyncTask<String ,Void ,String> {
    Context ctx;
    AlertDialog alertDialog;
    BackgroundTaskTeacher(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String log_url = "http://10.0.2.2/AndroidApp/teacherdb.php";
