...
class Student_poll_database_connectivity extends AsyncTask<String ,Void ,String> {
    Context ctx;
    AlertDialog alertDialog;
    Student_poll_database_connectivity(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String log_url = "http://10.10.2.2/AndroidApp/student_poll_response.php";
