...
/**
 * Created by DIVAKAR on 18-11-2016.
 */

class Backgroundquiz extends AsyncTask<String ,Void ,String> {
    Context ctx;
    AlertDialog alertDialog;
    Backgroundquiz(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String log_url = "http://192.168.43.31/score.php";
